 ...
 * 添加授权策略到用户分组
 */
public class ApiModifyGroupPolicies extends Api {
     ...
     */
    public ApiModifyGroupPolicies(Client client) {
        super(client);
    }
     ...
     **/
    public ApiModifyGroupPolicies(Client client, Config config) {
        super(client, config);
    }
    ...
    public static class Request extends Api.Request {
         ...
         * 为用户分组修改授权策略参数
         */
        private ModifiedGroupIamPoliciesParam data;
         ...
         * @param data      为用户分组修改授权策略参数 【必须】
         */
        public Request(String urlPrefix, String alias, ModifiedGroupIamPoliciesParam data) {
            super(urlPrefix);
         ...
         * 为用户分组修改授权策略参数
         */
        public static final class ModifiedGroupIamPoliciesParam {
             ...
             * @return Request
             */
            public ModifiedGroupIamPoliciesParam setPolicyAliases(String[] policyAliases) {
