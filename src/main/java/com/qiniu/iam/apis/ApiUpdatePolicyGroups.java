...
/**
  * 重新分配用户分组给指定策略
 */
public class ApiUpdatePolicyGroups extends Api {
     ...
     */
    public ApiUpdatePolicyGroups(Client client) {
        super(client);
    }
     ...
     **/
    public ApiUpdatePolicyGroups(Client client, Config config) {
        super(client, config);
    }
    ...
    public static class Request extends Api.Request {
         ...
         * 为授权策略重新分配分组参数
         */
        private UpdatedPolicyGroupsParam data;
         ...
         * @param data 为授权策略重新分配分组参数 【必须】
         */
        public Request(String urlPrefix, String alias, UpdatedPolicyGroupsParam data) {
            super(urlPrefix);
        ...
        /**
          * 为授权策略重新分配分组参数
          */
        public static final class UpdatedPolicyGroupsParam {
             ...
             * @return Request
             */
            public UpdatedPolicyGroupsParam setGroupAliases(String[] groupAliases) {
