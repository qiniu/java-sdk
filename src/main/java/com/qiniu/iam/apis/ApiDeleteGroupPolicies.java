 ...
 * 从用户分组中删除授权策略
 */
public class ApiDeleteGroupPolicies extends Api {
     ...
     */
    public ApiDeleteGroupPolicies(Client client) {
        super(client);
    }
     ...
     **/
    public ApiDeleteGroupPolicies(Client client, Config config) {
        super(client, config);
    }
    ...
    public static class Request extends Api.Request {
         ...
         * 从用户分组中删除授权策略参数
         */
        private DeletedGroupIamPoliciesParam data;
         ...
         * 从用户分组中删除授权策略参数
         */
        public static final class DeletedGroupIamPoliciesParam {
             ...
             * @return Request
             */
            public DeletedGroupIamPoliciesParam setPolicyAliases(String[] policyAliases) {
