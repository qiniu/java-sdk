...
/**
  * 查询授权策略分配的用户分组列表
 */
public class ApiGetPolicyGroups extends Api {
     ...
     */
    public ApiGetPolicyGroups(Client client) {
        super(client);
    }
     ...
     **/
    public ApiGetPolicyGroups(Client client, Config config) {
        super(client, config);
    }
    ...
    public static class Response extends Api.Response {
         ...
         * 返回的授权策略分配的用户分组列表响应
         */
        private GetPolicyGroupsResp data;
    
        protected Response(com.qiniu.http.Response response) throws QiniuException {
            super(response);
    
            this.data = Json.decode(response.bodyString(), GetPolicyGroupsResp.class);
        }
    
        /**
         * 响应信息
         *
         * @return GetPolicyGroupsResp
         */
        public GetPolicyGroupsResp getData() {
            return this.data;
        }
        ...
        /**
          * 返回的授权策略分配的用户分组
          */
        public static final class GetPolicyGroup {
        ...
        /**
          * 返回的授权策略分配的用户分组列表信息
          */
        public static final class GetPolicyGroupsData {
        ...
        /**
          * 返回的授权策略分配的用户分组列表响应
          */
        public static final class GetPolicyGroupsResp {
        
            /**
             * 授权策略分配的用户分组信息
             */
            @SerializedName("data")
            private GetPolicyGroupsData data;
             ...
             * @return data
             */
            public GetPolicyGroupsData getData() {
                return this.data;
            }
        }
    }
