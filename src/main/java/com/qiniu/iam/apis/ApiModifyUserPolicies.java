...
public class ApiModifyUserPolicies extends Api {
     ...
     */
    public ApiModifyUserPolicies(Client client) {
        super(client);
    }
     ...
     **/
    public ApiModifyUserPolicies(Client client, Config config) {
        super(client, config);
    }
    ...
    public static class Request extends Api.Request {
        ...
        public static final class ModifiedIamUserPoliciesParam {
             ...
             * @return Request
             */
            public ModifiedIamUserPoliciesParam setPolicyAliases(String[] policyAliases) {
