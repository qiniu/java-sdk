...
/**
  * 查询子账号下的授权策略
 */
public class ApiGetUserPolicies extends Api {
     ...
     */
    public ApiGetUserPolicies(Client client) {
        super(client);
    }
     ...
     **/
    public ApiGetUserPolicies(Client client, Config config) {
        super(client, config);
    }
    ...
    public static class Response extends Api.Response {
         ...
         */
        private GetIamUserPoliciesResp data;
    
        protected Response(com.qiniu.http.Response response) throws QiniuException {
            super(response);
    
            this.data = Json.decode(response.bodyString(), GetIamUserPoliciesResp.class);
        }
    
        /**
         * 响应信息
         *
         * @return GetIamUserPoliciesResp
         */
        public GetIamUserPoliciesResp getData() {
            return this.data;
        }
        ...
        /**
          * 返回的 IAM 子账号的授权策略
          */
        public static final class GetIamUserPolicy {
        ...
        /**
          ...
          */
        public static final class GetIamUserPoliciesData {
             ...
             * @return list
             */
            public GetIamUserPolicy[] getList() {
                return this.list;
            }
        }    
        /**
          * 返回的 IAM 子账号的授权策略列表响应
          */
        public static final class GetIamUserPoliciesResp {
        
            /**
             * IAM 子账号的授权策略信息
             */
            @SerializedName("data")
            private GetIamUserPoliciesData data;
             ...
             * @return data
             */
            public GetIamUserPoliciesData getData() {
                return this.data;
            }
        }
    }
