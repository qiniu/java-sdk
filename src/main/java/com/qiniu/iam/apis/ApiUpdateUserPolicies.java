 ...
 * 为子账号重新分配授权策略
 */
public class ApiUpdateUserPolicies extends Api {
     ...
     */
    public ApiUpdateUserPolicies(Client client) {
        super(client);
    }
     ...
     **/
    public ApiUpdateUserPolicies(Client client, Config config) {
        super(client, config);
    }
    ...
    public static class Request extends Api.Request {
         ...
         * 为子账号重新分配授权策略参数
         */
        private UpdatedIamUserPoliciesParam data;
         ...
         * @param data      为子账号重新分配授权策略参数 【必须】
         */
        public Request(String urlPrefix, String alias, UpdatedIamUserPoliciesParam data) {
            super(urlPrefix);
         ...
         * 为子账号重新分配授权策略参数
         */
        public static final class UpdatedIamUserPoliciesParam {
             ...
             * @return Request
             */
            public UpdatedIamUserPoliciesParam setPolicyAliases(String[] policyAliases) {
