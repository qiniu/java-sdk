...
public class ZoneTest {
        ...
        public void zone1() {
                ...
                Zone zone = new Zone.Builder().upHttp("http://up-sdfrsd-s.qiniubbo.com")
                                .upBackupHttp("http://up-sdfrsd-s.qiniubbo.com")
                                .rsHttp("http://rs-sdfrsd-s.qiniubbo.com").rsfHttp("http://rsf-sdfrsd-s.qiniubbo.com")
                                .apiHttp("http://apiserver-sdfrsd-s.qiniubbo.com")
                                .iovipHttp("http://io-sdfrsd-s.qiniubbo.com").build();

                Zone zone2 = new Zone.Builder(zone).iovipHttp("http://io-sdfrsd-s.qiniubbo.com").build();
