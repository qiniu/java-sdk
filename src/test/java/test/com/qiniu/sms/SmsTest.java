...
public class SmsTest {
	...
	@Test
	public void testComposeHeader() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException,
			NoSuchMethodException, SecurityException {
		Class<SmsManager> clazz = SmsManager.class;
		Method declaredMethod = clazz.getDeclaredMethod("composeHeader",
				new Class[] { String.class, String.class, byte[].class, String.class });
		declaredMethod.setAccessible(true);
		Object invoke = declaredMethod.invoke(this.smsManager,
				new Object[] { "http://sms.qiniuapi.com", MethodType.GET.toString(), null, Client.DefaultMime });
